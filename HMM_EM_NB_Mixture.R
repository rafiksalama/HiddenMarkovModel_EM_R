...
a = rnbinom(10,size = 1,mu = 1)
b = rnbinom(100,size = 2,mu = 5)
...
bs1w1 = dnbinom(data,size = s11s , mu = s11m)
bs1w2 = dnbinom(data,size = s12s , mu = s12m)
bs2w1 = dnbinom(data,size = s21s , mu = s21m)
...
be = c(v11s/s11m,v12s/s12m,v21s/s21m,v22s/s22m)
