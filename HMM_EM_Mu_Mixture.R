...
bs1w1 = dnorm(data,mean = s11m,s11s)
bs1w2 = dnorm(data,mean = s12m,s12s)
bs2w1 = dnorm(data,mean = s21m,s21s)
bs2w2 = dnorm(data,mean = s22m,s22s)
...
s11s = sqrt(sum(gammaM[,1]*((data-s11m)*t(data-s11m)))/sum(gammaM[,1]))
s12s = sqrt(sum(gammaM[,2]*((data-s12m)*t(data-s12m)))/sum(gammaM[,2]))
s21s = sqrt(sum(gammaM[,3]*((data-s21m)*t(data-s21m)))/sum(gammaM[,3]))
s22s = sqrt(sum(gammaM[,4]*((data-s12m)*t(data-s22m)))/sum(gammaM[,4]))
