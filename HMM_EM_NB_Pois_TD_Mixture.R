...
bs1w1 = dnbinom(data,mu=(exp(B1)*(X^G1)), size=exp(B1)*((X)^G1)/((exp(B1)*((X)^G1)*0.2313)))+1e-300
bs1w2 = dnbinom(round(data),size = s12s , mu = s12m)+1e-300
bs2w1 = dnbinom(data,mu=(exp(B2)*(X^G2)), size=exp(B2)*((X)^G2)/((exp(B2)*((X)^G2)*0.2313)))+1e-300
