...
#{
#Gaussian fit
MixtureParameters[[1]][1,] = mean(data)+runif(NumberOfStates)
MixtureParameters[[1]][2,] = 10+runif(NumberOfStates)
MixtureParameters[[2]][1,] = 20+runif(NumberOfStates)
MixtureParameters[[2]][2,] = sd(data)+runif(NumberOfStates)
